(function ($) {
    $(function () {
        ...
        if ($("#distribution-chart").length) {
            var areaData = {
                labels: ["Ropa", "Comida", "Gasolina", "Despensa", "Cervezas"],
                datasets: [{
                    data: [21500, 14560, 12200, 12343,38764],
                    backgroundColor: [
                        "#3da5f4", "#f1536e", "#fda006", "#2db37d", "#e8d01c"
                    ],
            ...
            var areaOptions = {
                ...
                legendCallback: function (chart) {
                    ...
                    text.push('<p>Gasolina</p>');
                    text.push('</div>');
                    text.push('<div class="item"><div class="legend-label" style="border: 3px solid ' + chart.data.datasets[0].backgroundColor[3] + '"></div>');
                    text.push('<p>Despensa</p>');
                    text.push('</div>');
                    text.push('<div class="item"><div class="legend-label" style="border: 3px solid ' + chart.data.datasets[0].backgroundColor[4] + '"></div>');
                    text.push('<p>Despensa</p>');
                    text.push('</div>');
                    text.push('</div>');
                    return text.join("");
